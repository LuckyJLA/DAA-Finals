...
for coord in coordinates:
    marker = folium.Marker(location=coord, popup='Marker Popup Text')
    marker.add_to(view)

n=1 #eme lang kasi gusto ko magbago ng kulay
for path in paths: 
    c='blue'
    ...
    #plots the roads
    folium.PolyLine(locations=route_coordinates, color=c, weight=6).add_to(view)
    n+=1
